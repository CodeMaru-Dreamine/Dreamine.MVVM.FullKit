    ...
    public static void Main()
    {
        ...
        builder.Services.AddDreamineBlazorServer<AppShell>(options =>
        {
            ...
            options.ConfigureServices = services =>
            {
                ...
                services.AddSingleton<IOntologyDataPathResolver, OntologyDataPathResolver>();
                services.AddSingleton<IOntologySourcePathResolver, OntologySourcePathResolver>();
                services.AddSingleton<IOntologyRepository, JsonOntologyRepository>();
                services.AddSingleton<IOntologyRelationResolver, OntologyRelationResolver>();
                services.AddSingleton<IOntologyGraphMapper, OntologyGraphMapper>();
