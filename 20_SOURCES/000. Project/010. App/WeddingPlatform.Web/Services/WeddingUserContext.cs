...
/// <summary>
/// \if KO
/// <para>Wedding Current User 기능과 관련 상태를 캡슐화합니다.</para>
/// \endif
/// \if EN
/// <para>Encapsulates wedding current user functionality and related state.</para>
/// \endif
/// </summary>
...
/// <summary>
/// \if KO
/// <para>Wedding User Context 기능과 관련 상태를 캡슐화합니다.</para>
/// \endif
/// \if EN
/// <para>Encapsulates wedding user context functionality and related state.</para>
/// \endif
/// </summary>
public sealed class WeddingUserContext
{
    ...
    /// <summary>
    /// \if KO
    /// <para>지정한 설정으로 <see cref="WeddingUserContext"/> 클래스의 새 인스턴스를 초기화합니다.</para>
    /// \endif
    /// \if EN
    /// <para>Initializes a new instance of the <see cref="WeddingUserContext"/> class with the specified settings.</para>
    /// \endif
    /// </summary>
    ...
    /// <returns>
    /// \if KO
    /// <para>Get Current Async 작업에서 생성한 <c>Task&lt;WeddingCurrentUser&gt;</c> 결과입니다.</para>
    /// \endif
    /// \if EN
    /// <para>The <c>Task&lt;WeddingCurrentUser&gt;</c> result produced by the get current async operation.</para>
    /// \endif
    /// </returns>
