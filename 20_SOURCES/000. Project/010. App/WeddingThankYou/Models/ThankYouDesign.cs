...
public sealed record ThankYouThemeDescriptor(
    string Key,
    string Primary,
    string Accent,
    string Label);
...
{
    public static readonly IReadOnlyList<ThankYouThemeDescriptor> Themes =
    [
    ...
    public static ThankYouThemeDescriptor GetTheme(string? key) =>
    ...
    public static void Normalize(TenantConfig config)
    {
        ...
        config.ThemeName = GetTheme(themeKey).Key;
