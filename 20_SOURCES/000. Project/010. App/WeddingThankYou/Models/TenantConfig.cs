...
/// <summary>
/// \if KO
/// <para>\file TenantConfig.cs \brief 슬러그(테넌트)별 웨딩 감사장 설정 모델. \details WeddingPlatform.Web의 TenantConfig를 ThankYou 전용으로 이식.</para>
/// \endif
/// \if EN
...
public sealed class TenantConfig
{
    ...
    /// <summary>
    /// \if KO
    /// <para>Hero Panel Placement 값을 가져오거나 설정합니다.</para>
    /// \endif
    /// \if EN
    /// <para>Gets or sets the hero panel placement value.</para>
    /// \endif
    /// </summary>
    ...
    /// <summary>
    /// \if KO
    /// <para>마음 전하실 곳 — 신랑·신부·부모님 계좌 및 연락처</para>
    /// \endif
    /// \if EN
    ...
    /// <summary>
    /// \if KO
    /// <para>테마 이름 — rose(기본), ivory, forest, navy, blush</para>
    /// \endif
    /// \if EN
    ...
    /// <summary>
    /// \if KO
    /// <para>감사장 레이아웃 스타일 — "onepage"(기본, 위→아래 스크롤) 또는 "tabs"(하단 탭 메뉴)</para>
    /// \endif
    /// \if EN
    /// <para>Gets or sets the thank you style value.</para>
    /// \endif
    /// </summary>
    ...
    /// <summary>
    /// \if KO
    /// <para>감사장 하단에서 연결할 외부 청첩장 URL. 비어 있으면 청첩장 보기 링크를 숨깁니다.</para>
    /// \endif
    /// \if EN
    /// <para>Gets or sets the invitation url value.</para>
    /// \endif
    /// </summary>
    ...
    /// <summary>
    /// \if KO
    /// <para>메인 페이지(공개 목록)에 노출할지 여부</para>
    /// \endif
    /// \if EN
...
/// <summary>
/// \if KO
/// <para>Thank You Admin User 기능과 관련 상태를 캡슐화합니다.</para>
/// \endif
/// \if EN
/// <para>Encapsulates thank you admin user functionality and related state.</para>
/// \endif
/// </summary>
