...
/// <summary>
/// \if KO
/// <para>Family Current User 기능과 관련 상태를 캡슐화합니다.</para>
/// \endif
/// \if EN
/// <para>Encapsulates family current user functionality and related state.</para>
/// \endif
/// </summary>
...
/// <summary>
/// \if KO
/// <para>Family User Context 기능과 관련 상태를 캡슐화합니다.</para>
/// \endif
/// \if EN
/// <para>Encapsulates family user context functionality and related state.</para>
/// \endif
/// </summary>
public sealed class FamilyUserContext
{
    ...
    /// <summary>
    /// \if KO
    /// <para>지정한 설정으로 <see cref="FamilyUserContext"/> 클래스의 새 인스턴스를 초기화합니다.</para>
    /// \endif
    /// \if EN
    /// <para>Initializes a new instance of the <see cref="FamilyUserContext"/> class with the specified settings.</para>
    /// \endif
    /// </summary>
    ...
    /// <returns>
    /// \if KO
    /// <para>Get Current Async 작업에서 생성한 <c>Task&lt;FamilyCurrentUser&gt;</c> 결과입니다.</para>
    /// \endif
    /// \if EN
