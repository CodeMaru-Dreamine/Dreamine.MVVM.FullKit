...
public sealed class CameraDevice
{
    ...
    /// <summary>\brief HLS 재생 URL. 직접 HLS면 원본 URL, RTSP면 중앙 서버 경로(/hls/{tenantId}/{id}/index.m3u8).</summary>
    public string HlsUrl => IsDirectHls ? RtspUrl : $"/hls/{TenantId}/{Id}/index.m3u8";
}
