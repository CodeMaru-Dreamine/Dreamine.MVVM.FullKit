...
/// <summary>
/// \if KO
/// <para>\brief Serial 통신 샘플 탭 이벤트 처리 클래스입니다.</para>
/// \endif
/// \if EN
/// <para>Encapsulates serial communication tab event functionality and related state.</para>
/// \endif
/// </summary>
public sealed class SerialCommunicationTabEvent
{
    ...
    /// <summary>
    /// \if KO
    /// <para>\brief SerialCommunicationTabEvent 클래스의 새 인스턴스를 초기화합니다.</para>
    /// \endif
    /// \if EN
    /// <para>Initializes a new instance of the <see cref="SerialCommunicationTabEvent"/> class with the specified settings.</para>
    /// \endif
    /// </summary>
    /// <param name="runtime">
    /// \if KO
