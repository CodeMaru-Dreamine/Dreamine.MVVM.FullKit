...
- [BabyCare](20_SOURCES/000.%20Project/010.%20App/BabyCare.Web/README.md): shared family care journal, nursing/solids/pumping, photos and ten languages.
- [Games](20_SOURCES/000.%20Project/010.%20App/GamePlatform.Web/README_KO.md): persistent game progression, shared territories, parties, rankings and browser audio.

Both applications have automated tests and coverage collection in CI. Badges above show published main-branch results; pending PR checks are shown on the pull request. Service deployment remains manual.
